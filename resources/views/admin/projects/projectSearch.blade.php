                ...
                <div class="card-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{ route('admin.projects.show', $project) }}" class="text-decoration-none">{{ $project->title }}</a></td>
                                <td>{{ date('d-m-Y', strtotime($project->StartDate)) }}</td>
                                <td><a href="{{ route('admin.projects.edit', $project) }}" class="text-decoration-none">Bewerken</a></td>
