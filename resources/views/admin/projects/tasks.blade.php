            ...
            <div class="card">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <a href="#" class="nav-link active" type="button" aria-selected="false">Taken</a>
                    </div>
                </nav>
                <div class="card-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <!-- if statement voor open en gesloten taken. user kan dit aangeven bij de user kant van de site-->
