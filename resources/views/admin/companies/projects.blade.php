        ...
        <div class="col-md-10">
            ...
            <div class="card">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('admin.companies.projects', $company) }}">Projecten</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="" class="text-decoration-none">{{ $project->project->title }}</a></td>
